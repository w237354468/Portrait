...
@Service
public class YearBaseImpl extends BaseMongo {
...
//        AggregateIterable<Document> iterator = collection.aggregate((List<Document>) Arrays.asList(group, project));
//
